...
export default function ScheduleSetup({ data, setData, studyDays, setStudyDays, onComplete, ProgressBar }: Props) {
    ...
    <div className="min-h-screen flex items-center justify-center p-10">
      <div className="max-w-[440px] w-full">
        ...
        <div style={{ animation: "fadeUp 0.4s ease" }}>
          ...
          <button className="btn btn-p" onClick={onComplete} style={{ width: "100%", padding: 15, borderRadius: 12 }}>Start my plan <ArrowRight size={16} /></button>
